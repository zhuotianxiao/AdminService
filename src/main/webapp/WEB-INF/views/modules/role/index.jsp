...
<head>
    ...
    <script>
        ...
        function remindDelete (modelId,key){
            $("#model-ok").attr("href","${ctx}/role/delete?id="+key);
...
<div class="row">
    <div class="col-md-12">
        <ul class="nav nav-tabs">
            <li class="active"><a href="${ctx}/role/index">角色列表</a></li>
            <shiro:hasPermission name="sys:role:edit">
            <li class=""><a href="${ctx}/role/form">新增/编辑</a></li>
            </shiro:hasPermission>
        </ul>
                ...
                <div class="panel panel-inverse">
                    ...
                    <div class="panel-body">
                        <table id="data-table" class="table table-striped table-bordered nowrap" width="100%">
                            ...
                            <tbody>
                            <c:forEach items="${list}" var="role" varStatus="idxStatus">
                                <tr class="unread">
                                    <td>${role.name}</td>
                                    <td>${role.roleType}</td>
                                    <td>
                                        <a href="${ctx}/role/form?id=${role.id}"><span class="label label-primary">修改</span></a>
                                        <a href="javascript:remindDelete('modal-message','${role.id}')"><span class="label label-danger">删除</span></a>
                                    </td>
                                </tr>
                            </c:forEach>
                            </tbody>
