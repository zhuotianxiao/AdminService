            ...
            $.ajax({
                ...
                success: function (data) {
                    if (data.result == 1) {
                        ...
                        document.location.href = "${ctx}/auth/company/index";
                        return;
                    } else {
                        alert("处理失败");
                    }
                    ...
                    <div class="panel-body panel-form">
                        <form action="${ctx}/account/company/auth" method="post"
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-md-2">${company.linkman}</div>
                            </div>

                            <div class="form-group">
                                <label class="control-label col-md-4 col-sm-4">联系人手机号码:</label>

                                <div class="col-md-2 col-sm-6">${company.phone}
                                </div>
                            </div>
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-md-2">${company.orgCode}
                                </div>
                            </div>
                            <div class=" form-group">
                                ...
                                <div class="col-md-2">
                                    <div class="row fileupload-buttonbar">
                                        <div class="col-md-7">
                                            ...
                                            <img src="${company.businessLicence}" id="img" width="100px"/>
                                        </div>
                                    </div>
                                </div>
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-md-6">
                                    <label class="radio-inline">
                                        <input type="radio" name="account.isAuth" value="1"
                                               <c:if test="${company.account.isAuth}">checked</c:if>
                                               class="radio-inline"/>
                                        已认证
                                    </label>
                                    <label class="radio-inline">
                                        <input type="radio" name="account.isAuth" value="0"
                                               <c:if test="${!company.account.isAuth}">checked</c:if>
                                               class="radio-inline"/>
                                        未认证
                                    </label>
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-md-6">
                                    <textarea rows="5" placeholder="审核结果说明" class="form-control">${company.choose}</textarea>
                                </div>
                            </div>

                            <div class="form-group">
                                <label class="control-label col-md-4 col-sm-4"></label>
                                <input type="hidden" id="status" name="compAuth"/>
