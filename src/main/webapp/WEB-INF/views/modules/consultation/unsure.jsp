...
<div class="row">
    <div class="col-md-12">
        <ul class="nav nav-tabs">
            <li class="active"><a href="${ctx}/consultation/list/unsure">待专家确认咨询服务列表</a></li>
            ...
            <div class="tab-pane fade active in" id="default-tab-1">
                ...
                <div class="panel panel-inverse">
                    <div class="panel-heading">
                        ...
                        <h4 class="panel-title">待专家确认咨询服务列表</h4>
                    </div>
                            ...
                            <c:forEach items="${list}" var="consultation" varStatus="idxStatus">
                                <tr class="unread">
                                    ...
                                    <td>
                                        ...
                                        <a href="${ctx}/consultation/list/info/${consultation.id}"><span
                                                class="label label-primary">查看确认</span></a>
                                    </td>
                                </tr>
                            </c:forEach>
                            </tbody>
