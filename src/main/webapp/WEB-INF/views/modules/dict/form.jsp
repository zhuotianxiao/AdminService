...
<div class="row">
    <div class="col-md-12">
        <ul class="nav nav-tabs">
            <li class=""><a href="${ctx}/dict/index">字典列表</a></li>
            <shiro:hasPermission name="sys:dict:edit">
                <li class="active"><a href="${ctx}/dict/form">新增/编辑</a></li>
            </shiro:hasPermission>
            <shiro:lacksPermission name="sys:dict:edit">
                <li class="active"><a href="${ctx}/dict/form">查看</a></li>
            ...
            <div class="tab-pane fade active in" id="default-tab-1">
                ...
                <div class="panel panel-primary" data-sortable-id="form-validation-2">
                    ...
                    <div class="panel-body panel-form">
                        <form:form modelAttribute="dict" action="save" class="form-horizontal form-bordered" data-parsley-validate="true">
                            <form:hidden path="id" />
                            <div class="form-group">
                                <label class="control-label col-md-4 col-sm-4">字典类型:</label>
                                <div class="col-md-2 col-sm-6">
                                    <form:input path="type" type="text" class="form-control" data-parsley-required="true" placeholder="字典类型" />
                                </div>
                            </div>
                            <div class="form-group">
                                <label class="control-label col-md-4 col-sm-4">标签名:</label>
                                <div class="col-md-2">
                                    <form:input path="label" type="text" class="form-control" data-parsley-required="true" placeholder="标签名" />
                                </div>
                            </div>
                            <div class="form-group">
                                <label class="control-label col-md-4 col-sm-4">数据值:</label>
                                <div class="col-md-2">
                                    <form:input path="value" type="text" class="form-control" data-parsley-required="true" placeholder="数据值" />
                                </div>
                            </div>
                            <div class="form-group">
                                <label class="control-label col-md-4 col-sm-4">描述:</label>
                                <div class="col-md-6 col-sm-6">
                                    <form:input path="description" type="text" class="form-control" placeholder="描述" />
                                </div>
                            </div>
                            <div class="form-group">
