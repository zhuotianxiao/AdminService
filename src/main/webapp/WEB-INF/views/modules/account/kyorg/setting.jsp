				...
				<div class="tab-pane fade active in" id="default-tab-1">
					...
					<div class="panel panel-inverse"
						...
						<div class="panel-heading">
							...
							<h4 class="panel-title">设置科研机构前台展示</h4>
						</div>
						<div class="panel-body panel-form">
							<form:form modelAttribute="kyOrg"
								action="${ctx}/account/kyorg/setting"
								...
								<div class="form-group">
									<label class="control-label col-md-4 col-sm-4">专家推荐值:</label>
									<div class="col-md-2">
										<form:input path="recommendNum" type="text"
											class="form-control" data-parsley-required="true"
											placeholder="专家推荐值" data-parsley-id="2694"
								...
								<div class="form-group">
									<label class="control-label col-md-4 col-sm-4">专家热门值:</label>
									<div class="col-md-2">
										<form:input path="hotNum" type="text" class="form-control"
											data-parsley-required="true" placeholder="专家热门值"
								...
								<div class="form-group">
									<label class="control-label col-md-4 col-sm-4">专家最新值:</label>
									<div class="col-md-2">
										<form:input path="latestNum" type="text" class="form-control"
											data-parsley-required="true" placeholder="专家最新值"
