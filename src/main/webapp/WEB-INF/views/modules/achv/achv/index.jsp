...
<head>
    ...
    <script>
        ...
        function remindDelete(modelId,key,flag){
            ...
            $("#"+modelId).find("#model-ok").attr("href","${ctx}/achv/achv/valid/"+key+"/"+flag);
            $(function () {
            	$('#'+modelId).modal({
                	keyboard: true
            	});
...
<div class="row">
    <div class="col-md-12">
        <ul class="nav nav-tabs">
            <li class="active"><a href="${ctx}/account/expert/index">成果综合列表</a></li>
            ...
            <div class="tab-pane fade active in" id="default-tab-1">
                ...
                <div class="panel panel-inverse">
                    <div class="panel-heading">
                        ...
                        <h4 class="panel-title">专家列表列表</h4>
                    </div>
                            ...
                            <c:forEach items="${list}" var="achv" varStatus="idxStatus">
                                <tr class="unread">
                                    ...
                                    <td>
                                        ...
                                        <a href="${ctx}/achv/achv/info/${achv.id}"><span class="label label-primary">详细</span></a>
                                        <a href="${ctx}/achv/achv/setting/${achv.id}"><span class="label label-primary">设置前台显示</span></a>
									</td>
                                </tr>
                            </c:forEach>
                            </tbody>
