...
//	private List<User> userList = Lists.newArrayList(); // 拥有用户列表
	...
	// 数据范围（0：所有数据；1：所在公司及以下数据；2：所在公司数据；3：所在部门及以下数据；4：所在部门数据；5：仅本人数据；6：按明细设置）
	public static final String DATA_SCOPE_ALL = "0";
	public static final String DATA_SCOPE_COMPANY_AND_CHILD = "1";
	public static final String DATA_SCOPE_COMPANY = "2";
	public static final String DATA_SCOPE_OFFICE_AND_CHILD = "3";
	public static final String DATA_SCOPE_OFFICE = "4";
	public static final String DATA_SCOPE_SELF = "5";
	public static final String DATA_SCOPE_CUSTOM = "6";
