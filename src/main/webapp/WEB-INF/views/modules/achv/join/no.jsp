...
<head>
    ...
    <script>
        ...
        function remindDelete(modelId,key,flag){
            ...
            $("#"+modelId).find("#model-ok").attr("href","${ctx}//achv/join/no/valid/"+key+"/"+flag);
            $(function () {
            	$('#'+modelId).modal({
                	keyboard: true
            	});
...
<div class="row">
    <div class="col-md-12">
        <ul class="nav nav-tabs">
			<li class="active"><a href="${ctx}/achv/join/no">待处理列表</a></li>
                            ...
                            <c:forEach items="${list}" var="achv" varStatus="idxStatus">
                                <tr class="unread">
                                    ...
                                    <td>
                                        ...
                                        <a href="${ctx}/achv/join/setting/no/${achv.id}"><span class="label label-primary">设置前台显示</span></a>
									</td>
                                </tr>
                            </c:forEach>
                            </tbody>
