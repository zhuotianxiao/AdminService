...
<div class="row">
    <div class="col-md-12">
        <ul class="nav nav-tabs">
            <li class="active"><a href="${ctx}/auth/company/index">企业待认证审核管理</a></li>
            ...
            <div class="tab-pane fade active in" id="default-tab-1">
                ...
                <div class="panel panel-inverse">
                    <div class="panel-heading">
                        ...
                        <h4 class="panel-title">企业待认证审核列表</h4>
                    </div>
                            ...
                            <c:forEach items="${list}" var="company" varStatus="idxStatus">
                                <tr class="unread">
                                    ...
                                    <td>
                                        ...
                                        <a href="${ctx}/auth/company/auth/${company.accountId}"><span
