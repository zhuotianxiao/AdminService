...
<div class="row">
    <div class="col-md-12">
        <ul class="nav nav-tabs">
            <li class="active"><a href="${ctx}/office/index">部门列表</a></li>
            <shiro:hasPermission name="sys:office:edit">
            <li class=""><a href="${ctx}/office/form">新增/编辑</a></li>
            </shiro:hasPermission>
        </ul>
                ...
                <div class="panel panel-inverse">
                    ...
                    <div class="panel-body">
                        <table id="data-table" class="table table-striped table-bordered nowrap" width="100%">
                            ...
                            <tbody>
                            <c:forEach items="${list}" var="office" varStatus="idxStatus">
                                <tr class="unread">
                                        <%--<tr class="odd gradeX">--%>
                                    <td>${office.name}</td>
                                    <td>${fns:getDictLabel(office.type, 'sys_office_type', '未填写')}</td>
                                    <td>${office.parent.name}</td>
                                    <td>
                                        <a href="${ctx}/office/form?id=${office.id}"><span class="label label-primary">修改</span></a>
                                        <a href="javascript:remindDelete('modal-message','${office.id}')"><span class="label label-danger">删除</span></a>
                                    </td>
                                </tr>
                            </c:forEach>
                            </tbody>
