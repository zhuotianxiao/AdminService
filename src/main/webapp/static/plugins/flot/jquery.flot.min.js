...
(function ($) {
    ...
    Canvas.prototype.addText = function (layer, x, y, text, font, angle, width, halign, valign,showCount) {
    ...
    function Plot(placeholder, data_, options_, plugins) {//console.log(placeholder);console.log(data_);console.log(options_);console.log(plugins);
        var series = [],
            options = {
            ...
            $.each(allAxes(),
                function (_, axis) {
                    ...
                    for (var i = 0; i < axis.ticks.length; ++i) {
                        ...
                        //surface.addText(layer, x, y, tick.label, font, null, null, halign, "top");//在上面添加数量
                    }
                })
        }
        ...
        function drawBar(x, y, b, barLeft, barRight, fillStyleCallback, axisx, axisy, c, horizontal, lineWidth) {//alert(0);
        ...
        function drawSeriesBars(series) {//console.log(111);
